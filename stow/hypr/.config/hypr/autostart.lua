local sessionEnvironment =
  "WAYLAND_DISPLAY HYPRLAND_INSTANCE_SIGNATURE XDG_CURRENT_DESKTOP XDG_SESSION_TYPE XDG_SESSION_DESKTOP XCURSOR_THEME XCURSOR_SIZE XCURSOR_PATH HYPRCURSOR_SIZE GBM_BACKEND __GLX_VENDOR_LIBRARY_NAME LIBVA_DRIVER_NAME WLR_DRM_DEVICES WLR_RENDER_DRM_DEVICE WLR_NO_HARDWARE_CURSORS"
