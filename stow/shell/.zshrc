...
if command -v eza &>/dev/null; then
    ...
    alias la='eza -lah --icons --group-directories-first --color=auto'
    alias lt='eza --tree --level=2 --icons --color=auto'
    alias lta='eza --tree --level=2 --icons -a --color=auto'
fi

# EZA_COLORS is generated by matugen into ~/.config/zsh/highlight-colors.zsh
export LS_COLORS=""
