...
# Colorize completions - colors are set by ~/.config/zsh/highlight-colors.zsh (generated by flavours)
# Default fallback if theme file doesn't exist
...
# ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE is set by ~/.config/zsh/highlight-colors.zsh (generated by flavours)
...
# Load syntax highlighting and autosuggestions colors from flavours-generated theme
# This must be loaded before oh-my-zsh to set plugin colors correctly
if [[ -f ~/.config/zsh/highlight-colors.zsh ]]; then
...
if command -v eza &>/dev/null; then
    ...
    alias ll='eza -lh --icons --group-directories-first --color=never'
    alias la='eza -lah --icons --group-directories-first --color=never'
    alias lt='eza --tree --level=2 --icons --color=never'
    alias lta='eza --tree --level=2 --icons -a --color=never'
fi

# Disable eza built-in colors to use terminal color scheme from flavours
export EZA_COLORS=""
export LS_COLORS=""
